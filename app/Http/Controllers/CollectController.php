...
class CollectController extends Controller
{
    ...
    public function go_to_colprint($sid, $cid)
    {
     ...
     if ($totaldegree === null) {
        ...
        return view('colprint',compact('student',$sid,'course',$cid,"col_obtained",$col_obtained,'course_components',$course_components,'total',$total,'course_degrees',$course_degrees,'current_date',$current_date));
    }
