...
<!-- Select Basic -->
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
          <input id="course_cost" name="course_cost" placeholder="cost" class="form-control input-md" required="" type="number">
          </div>
        </div>
        <div class="form-group">
        <!-- <div class="boddy " >
      ...
      <div class="form-group">
          <label class="col-md-4 control-label" for="teacher_percentage">Teacher Percentage</label>
          <div class="col-md-2">
          <input id="teacher_percentage" name="teacher_percentage" class="form-control input-md" required="" type="number" >
          </div>
        </div>
